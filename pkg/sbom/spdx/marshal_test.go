...
import (
	...
	"github.com/w3security/cvescan/pkg/report"
	tspdx "github.com/w3security/cvescan/pkg/sbom/spdx"
	...
	}{
		{
			...
			wantSBOM: &spdx.Document2_2{
				CreationInfo: &spdx.CreationInfo2_2{
					...
					DocumentNamespace:    "http://w3security.github.io/cvescan/container_image/rails:latest-3ff14136-e09f-4df9-80ea-000000000001",
		...
		},
		{
			...
			wantSBOM: &spdx.Document2_2{
				CreationInfo: &spdx.CreationInfo2_2{
					...
					DocumentNamespace:    "http://w3security.github.io/cvescan/container_image/centos:latest-3ff14136-e09f-4df9-80ea-000000000001",
					CreatorOrganizations: []string{"aquasecurity"},
					CreatorTools:         []string{"trivy"},
					Created:              "2021-08-25T12:20:30.000000005Z",
				},
		...
		},
		{
			...
			wantSBOM: &spdx.Document2_2{
				CreationInfo: &spdx.CreationInfo2_2{
					...
					DocumentNamespace:    "http://w3security.github.io/cvescan/filesystem/masahiro331/CVE-2021-41098-3ff14136-e09f-4df9-80ea-000000000001",
					CreatorOrganizations: []string{"aquasecurity"},
					CreatorTools:         []string{"trivy"},
					Created:              "2021-08-25T12:20:30.000000005Z",
				},
		...
		},
		{
			...
			wantSBOM: &spdx.Document2_2{
				CreationInfo: &spdx.CreationInfo2_2{
					...
					DocumentNamespace:    "http://w3security.github.io/cvescan/repository/test-aggregate-3ff14136-e09f-4df9-80ea-000000000001",
					CreatorOrganizations: []string{"aquasecurity"},
					CreatorTools:         []string{"trivy"},
					Created:              "2021-08-25T12:20:30.000000005Z",
				},
		...
		},
		{
			...
			wantSBOM: &spdx.Document2_2{
				CreationInfo: &spdx.CreationInfo2_2{
					...
					DocumentNamespace:    "http://w3security.github.io/cvescan/filesystem/empty/path-3ff14136-e09f-4df9-80ea-000000000001",
					CreatorOrganizations: []string{"aquasecurity"},
					CreatorTools:         []string{"trivy"},
					Created:              "2021-08-25T12:20:30.000000005Z",
				},
