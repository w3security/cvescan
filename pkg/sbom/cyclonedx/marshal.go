...
import (
	...
	"github.com/w3security/cvescan/pkg/scanner/utils"
...
type Marshaler struct {
	appVersion string // cvescan version
	clock      clock.Clock
	newUUID    newUUID
}
...
// MarshalVulnerabilities converts the cvescan report to the CycloneDX format only with vulnerabilities.
...
func cdxRatingV2(sourceID dtypes.SourceID, severity dtypes.Severity, cvss dtypes.CVSS) cdx.VulnerabilityRating {
	...
	// cvescan keeps only CVSSv3 severity for NVD.
