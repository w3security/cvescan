...
// $ cvescan image --input alpine.tar
...
// $ cvescan image --server localhost:4954 alpine:3.15
...
// $ cvescan image --server localhost:4954 --input alpine.tar
