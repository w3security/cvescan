...
const (
	...
	builtinRulesUrl = "https://github.com/w3security/cvescan/blob/main/pkg/fanal/secret/builtin-rules.go" // list all secrets
)
...
func (sw SarifWriter) Write(report types.Report) error {
	...
	sw.run = sarif.NewRunWithInformationURI("Trivy", "https://github.com/w3security/cvescan")
