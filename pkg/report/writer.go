...
import (
	...
	"github.com/w3security/cvescan/pkg/compliance/spec"
	"github.com/w3security/cvescan/pkg/log"
	"github.com/w3security/cvescan/pkg/report/cyclonedx"
	"github.com/w3security/cvescan/pkg/report/github"
	"github.com/w3security/cvescan/pkg/report/predicate"
	"github.com/w3security/cvescan/pkg/report/spdx"
	"github.com/w3security/cvescan/pkg/report/table"
...
func Write(report types.Report, option Option) error {
	...
	case FormatTemplate:
		...
		if strings.HasPrefix(option.OutputTemplate, "@") && strings.HasSuffix(option.OutputTemplate, "sarif.tpl") {
			log.Logger.Warn("Using `--template sarif.tpl` is deprecated. Please migrate to `--format sarif`. See https://github.com/w3security/cvescan/discussions/1571")
			writer = SarifWriter{
				Output:  option.Output,
				Version: option.AppVersion,
			}
