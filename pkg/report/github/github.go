...
import (
	...
	"github.com/w3security/cvescan/pkg/clock"
...
func (w Writer) Write(report types.Report) error {
	...
	snapshot.Detector = Detector{
		Name:    "trivy",
		Version: w.Version,
		Url:     "https://github.com/w3security/cvescan",
	}
...
func getMetadata(report types.Report) Metadata {
	...
	if report.Metadata.RepoTags != nil {
		metadata["w3security:cvescan:RepoTag"] = strings.Join(report.Metadata.RepoTags, ", ")
	}
	if report.Metadata.RepoDigests != nil {
		metadata["w3security:cvescan:RepoDigest"] = strings.Join(report.Metadata.RepoDigests, ", ")
	}
	return metadata
}
