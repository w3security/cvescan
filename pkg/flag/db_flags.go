...
const defaultJavaDBRepository = "ghcr.io/w3security/cvescan-java-db"
...
var (
	...
	JavaDBRepositoryFlag = Flag{
		...
		Usage:      "OCI repository to retrieve cvescan-java-db from",
	}
	LightFlag = Flag{
		Name:       "light",
		ConfigName: "db.light",
...
func (f *DBFlagGroup) ToOptions() (DBOptions, error) {
	...
	if light {
		log.Logger.Warn("'--light' option is deprecated and will be removed. See also: https://github.com/w3security/cvescan/discussions/1649")
	}
