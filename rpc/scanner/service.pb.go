...
// Result is the same as github.com/w3security/cvescan/pkg/report.Result
type Result struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
var file_rpc_scanner_service_proto_goTypes = []interface{}{
	(*ScanRequest)(nil),                     // 0: cvescan.scanner.v1.ScanRequest
	(*Licenses)(nil),                        // 1: cvescan.scanner.v1.Licenses
	(*ScanOptions)(nil),                     // 2: cvescan.scanner.v1.ScanOptions
	(*ScanResponse)(nil),                    // 3: cvescan.scanner.v1.ScanResponse
	(*Result)(nil),                          // 4: cvescan.scanner.v1.Result
	nil,                                     // 5: cvescan.scanner.v1.ScanOptions.LicenseCategoriesEntry
	(*common.OS)(nil),                       // 6: cvescan.common.OS
	(*common.Vulnerability)(nil),            // 7: cvescan.common.Vulnerability
	(*common.DetectedMisconfiguration)(nil), // 8: cvescan.common.DetectedMisconfiguration
	(*common.Package)(nil),                  // 9: cvescan.common.Package
	(*common.CustomResource)(nil),           // 10: cvescan.common.CustomResource
	(*common.SecretFinding)(nil),            // 11: cvescan.common.SecretFinding
}
var file_rpc_scanner_service_proto_depIdxs = []int32{
	2,  // 0: cvescan.scanner.v1.ScanRequest.options:type_name -> cvescan.scanner.v1.ScanOptions
	5,  // 1: cvescan.scanner.v1.ScanOptions.license_categories:type_name -> cvescan.scanner.v1.ScanOptions.LicenseCategoriesEntry
	6,  // 2: cvescan.scanner.v1.ScanResponse.os:type_name -> cvescan.common.OS
	4,  // 3: cvescan.scanner.v1.ScanResponse.results:type_name -> cvescan.scanner.v1.Result
	7,  // 4: cvescan.scanner.v1.Result.vulnerabilities:type_name -> cvescan.common.Vulnerability
	8,  // 5: cvescan.scanner.v1.Result.misconfigurations:type_name -> cvescan.common.DetectedMisconfiguration
	9,  // 6: cvescan.scanner.v1.Result.packages:type_name -> cvescan.common.Package
	10, // 7: cvescan.scanner.v1.Result.custom_resources:type_name -> cvescan.common.CustomResource
	11, // 8: cvescan.scanner.v1.Result.secrets:type_name -> cvescan.common.SecretFinding
	1,  // 9: cvescan.scanner.v1.ScanOptions.LicenseCategoriesEntry.value:type_name -> cvescan.scanner.v1.Licenses
	0,  // 10: cvescan.scanner.v1.Scanner.Scan:input_type -> cvescan.scanner.v1.ScanRequest
	3,  // 11: cvescan.scanner.v1.Scanner.Scan:output_type -> cvescan.scanner.v1.ScanResponse
