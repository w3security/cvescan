...
var file_rpc_common_service_proto_goTypes = []interface{}{
	(Severity)(0),                    // 0: cvescan.common.Severity
	(*OS)(nil),                       // 1: cvescan.common.OS
	(*Repository)(nil),               // 2: cvescan.common.Repository
	(*PackageInfo)(nil),              // 3: cvescan.common.PackageInfo
	(*Application)(nil),              // 4: cvescan.common.Application
	(*Package)(nil),                  // 5: cvescan.common.Package
	(*Misconfiguration)(nil),         // 6: cvescan.common.Misconfiguration
	(*MisconfResult)(nil),            // 7: cvescan.common.MisconfResult
	(*DetectedMisconfiguration)(nil), // 8: cvescan.common.DetectedMisconfiguration
	(*Vulnerability)(nil),            // 9: cvescan.common.Vulnerability
	(*DataSource)(nil),               // 10: cvescan.common.DataSource
	(*Layer)(nil),                    // 11: cvescan.common.Layer
	(*CVSS)(nil),                     // 12: cvescan.common.CVSS
	(*CustomResource)(nil),           // 13: cvescan.common.CustomResource
	(*Line)(nil),                     // 14: cvescan.common.Line
	(*Code)(nil),                     // 15: cvescan.common.Code
	(*SecretFinding)(nil),            // 16: cvescan.common.SecretFinding
	(*Secret)(nil),                   // 17: cvescan.common.Secret
	nil,                              // 18: cvescan.common.Vulnerability.CvssEntry
	nil,                              // 19: cvescan.common.Vulnerability.VendorSeverityEntry
	(*timestamppb.Timestamp)(nil),    // 20: google.protobuf.Timestamp
	(*structpb.Value)(nil),           // 21: google.protobuf.Value
}
var file_rpc_common_service_proto_depIdxs = []int32{
	5,  // 0: cvescan.common.PackageInfo.packages:type_name -> cvescan.common.Package
	5,  // 1: cvescan.common.Application.libraries:type_name -> cvescan.common.Package
	11, // 2: cvescan.common.Package.layer:type_name -> cvescan.common.Layer
	7,  // 3: cvescan.common.Misconfiguration.successes:type_name -> cvescan.common.MisconfResult
	7,  // 4: cvescan.common.Misconfiguration.warnings:type_name -> cvescan.common.MisconfResult
	7,  // 5: cvescan.common.Misconfiguration.failures:type_name -> cvescan.common.MisconfResult
	7,  // 6: cvescan.common.Misconfiguration.exceptions:type_name -> cvescan.common.MisconfResult
	0,  // 7: cvescan.common.DetectedMisconfiguration.severity:type_name -> cvescan.common.Severity
	11, // 8: cvescan.common.DetectedMisconfiguration.layer:type_name -> cvescan.common.Layer
	0,  // 9: cvescan.common.Vulnerability.severity:type_name -> cvescan.common.Severity
	11, // 10: cvescan.common.Vulnerability.layer:type_name -> cvescan.common.Layer
	18, // 11: cvescan.common.Vulnerability.cvss:type_name -> cvescan.common.Vulnerability.CvssEntry
	20, // 12: cvescan.common.Vulnerability.published_date:type_name -> google.protobuf.Timestamp
	20, // 13: cvescan.common.Vulnerability.last_modified_date:type_name -> google.protobuf.Timestamp
	21, // 14: cvescan.common.Vulnerability.custom_advisory_data:type_name -> google.protobuf.Value
	21, // 15: cvescan.common.Vulnerability.custom_vuln_data:type_name -> google.protobuf.Value
	10, // 16: cvescan.common.Vulnerability.data_source:type_name -> cvescan.common.DataSource
	19, // 17: cvescan.common.Vulnerability.vendor_severity:type_name -> cvescan.common.Vulnerability.VendorSeverityEntry
	11, // 18: cvescan.common.CustomResource.layer:type_name -> cvescan.common.Layer
	21, // 19: cvescan.common.CustomResource.data:type_name -> google.protobuf.Value
	14, // 20: cvescan.common.Code.lines:type_name -> cvescan.common.Line
	15, // 21: cvescan.common.SecretFinding.code:type_name -> cvescan.common.Code
	11, // 22: cvescan.common.SecretFinding.layer:type_name -> cvescan.common.Layer
	16, // 23: cvescan.common.Secret.findings:type_name -> cvescan.common.SecretFinding
	12, // 24: cvescan.common.Vulnerability.CvssEntry.value:type_name -> cvescan.common.CVSS
	0,  // 25: cvescan.common.Vulnerability.VendorSeverityEntry.value:type_name -> cvescan.common.Severity
