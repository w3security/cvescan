...
import (
	common "github.com/w3security/cvescan/rpc/common"
...
var file_rpc_cache_service_proto_goTypes = []interface{}{
	(*ArtifactInfo)(nil),            // 0: cvescan.cache.v1.ArtifactInfo
	(*PutArtifactRequest)(nil),      // 1: cvescan.cache.v1.PutArtifactRequest
	(*BlobInfo)(nil),                // 2: cvescan.cache.v1.BlobInfo
	(*PutBlobRequest)(nil),          // 3: cvescan.cache.v1.PutBlobRequest
	(*PutResponse)(nil),             // 4: cvescan.cache.v1.PutResponse
	(*MissingBlobsRequest)(nil),     // 5: cvescan.cache.v1.MissingBlobsRequest
	(*MissingBlobsResponse)(nil),    // 6: cvescan.cache.v1.MissingBlobsResponse
	(*DeleteBlobsRequest)(nil),      // 7: cvescan.cache.v1.DeleteBlobsRequest
	(*timestamppb.Timestamp)(nil),   // 8: google.protobuf.Timestamp
	(*common.Package)(nil),          // 9: cvescan.common.Package
	(*common.OS)(nil),               // 10: cvescan.common.OS
	(*common.Repository)(nil),       // 11: cvescan.common.Repository
	(*common.PackageInfo)(nil),      // 12: cvescan.common.PackageInfo
	(*common.Application)(nil),      // 13: cvescan.common.Application
	(*common.Misconfiguration)(nil), // 14: cvescan.common.Misconfiguration
	(*common.CustomResource)(nil),   // 15: cvescan.common.CustomResource
	(*common.Secret)(nil),           // 16: cvescan.common.Secret
	(*emptypb.Empty)(nil),           // 17: google.protobuf.Empty
}
var file_rpc_cache_service_proto_depIdxs = []int32{
	8,  // 0: cvescan.cache.v1.ArtifactInfo.created:type_name -> google.protobuf.Timestamp
	9,  // 1: cvescan.cache.v1.ArtifactInfo.history_packages:type_name -> cvescan.common.Package
	0,  // 2: cvescan.cache.v1.PutArtifactRequest.artifact_info:type_name -> cvescan.cache.v1.ArtifactInfo
	10, // 3: cvescan.cache.v1.BlobInfo.os:type_name -> cvescan.common.OS
	11, // 4: cvescan.cache.v1.BlobInfo.repository:type_name -> cvescan.common.Repository
	12, // 5: cvescan.cache.v1.BlobInfo.package_infos:type_name -> cvescan.common.PackageInfo
	13, // 6: cvescan.cache.v1.BlobInfo.applications:type_name -> cvescan.common.Application
	14, // 7: cvescan.cache.v1.BlobInfo.misconfigurations:type_name -> cvescan.common.Misconfiguration
	15, // 8: cvescan.cache.v1.BlobInfo.custom_resources:type_name -> cvescan.common.CustomResource
	16, // 9: cvescan.cache.v1.BlobInfo.secrets:type_name -> cvescan.common.Secret
	2,  // 10: cvescan.cache.v1.PutBlobRequest.blob_info:type_name -> cvescan.cache.v1.BlobInfo
	10, // 11: cvescan.cache.v1.PutResponse.os:type_name -> cvescan.common.OS
	1,  // 12: cvescan.cache.v1.Cache.PutArtifact:input_type -> cvescan.cache.v1.PutArtifactRequest
	3,  // 13: cvescan.cache.v1.Cache.PutBlob:input_type -> cvescan.cache.v1.PutBlobRequest
	5,  // 14: cvescan.cache.v1.Cache.MissingBlobs:input_type -> cvescan.cache.v1.MissingBlobsRequest
	7,  // 15: cvescan.cache.v1.Cache.DeleteBlobs:input_type -> cvescan.cache.v1.DeleteBlobsRequest
	17, // 16: cvescan.cache.v1.Cache.PutArtifact:output_type -> google.protobuf.Empty
	17, // 17: cvescan.cache.v1.Cache.PutBlob:output_type -> google.protobuf.Empty
	6,  // 18: cvescan.cache.v1.Cache.MissingBlobs:output_type -> cvescan.cache.v1.MissingBlobsResponse
	17, // 19: cvescan.cache.v1.Cache.DeleteBlobs:output_type -> google.protobuf.Empty
