...
You can get the package names in the [defsec repository][defsec] or the JSON output from cvescan.

For more details, see [an example][rule-example].

[ns-example]: https://github.com/w3security/cvescan/tree/{{ git.commit }}/examples/misconf/namespace-exception
[rule-example]: https://github.com/w3security/cvescan/tree/{{ git.commit }}/examples/misconf/rule-exception
