...
```shell
$ cvescan repo --scanners config [YOUR_REPO_URL]
```
...
```shell
$ cvescan repo --scanners license [YOUR_REPO_URL]
```
...
```
$ cvescan repo --branch <branch-name> <repo-name>
```
...
```
$ cvescan repo --commit <commit-hash> <repo-name>
```
...
```
$ cvescan repo --tag <tag-name> <repo-name>
```
...
$ cvescan repo <your private GitHub repo URL>
$
$ # or
$ export GITLAB_TOKEN="your_private_gitlab_token"
$ cvescan repo <your private GitLab repo URL>
```
