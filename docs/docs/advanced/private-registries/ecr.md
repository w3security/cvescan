...
You may need to grant permissions to allow cvescan to pull images from private ECR.

It depends on how you want to provide AWS Role to cvescan.
...
Add the AWS role in cvescan's service account annotations:
