...
Triage is an important part of maintaining the health of the cvescan repo.
...
- `kind/documentation` - Updates or additions to cvescan documentation
...
> Could you please check to see if cvescan <x> addresses this issue? We've made some changes with how this is handled, and improved the cvescan logs output to help us debug tricky cases like this.
...
>@author: I believe this issue is now addressed by cvescan v1.0.0, as it <reason>. If you still see this issue with cvescan v1.0 or higher, please reopen this issue.
>
...
>
>\* Whether the issue occurs with the latest cvescan release
>
>\* The exact `trivy` command line used
>
>\* The exact image you want to scan
...
We use two labels [help wanted](https://github.com/w3security/cvescan/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22)
and [good first issue](https://github.com/w3security/cvescan/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
