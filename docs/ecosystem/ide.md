...
👉 Get it at: <https://github.com/w3security/cvescan-vscode-extension>

## JetBrains (Official)
[JetBrains](https://jetbrains.com) makes IDEs such as Goland, Pycharm, IntelliJ, Webstorm, and more.

The cvescan plugin for JetBrains IDEs lets you use cvescan right from your development environment.
...
👉 Get it at: <https://github.com/w3security/cvescan-operator-lens-extension>

## Vim (Community)
[Vim](https://www.vim.org/) is a terminal based text editor.

Vim plugin for cvescan to install and run cvescan.
...
👉 Get it at: <https://github.com/w3security/cvescan-docker-extension>
...
## LazyTrivy (Community)
A terminal native UI for cvescan

👉 Get it at: <https://github.com/owenrumney/lazytrivy>

## cvescan Vulnerability explorer (Community)

Web application that allows to load a cvescan report in json format and displays the vulnerabilities of a single target in an interactive data table

👉 Get it at: <https://github.com/dbsystel/trivy-vulnerability-explorer>

## cvescan pre-commit (Community)

A cvescan pre-commit hook that runs a `trivy fs` in your git repo before commiting, preventing you from commiting secrets in the first place.
