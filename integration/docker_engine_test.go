...
func TestDockerEngine(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "alpine:3.9",
			imageTag: "ghcr.io/w3security/cvescan-test-images:alpine-39",
		...
		},
		{
			...
			imageTag: "ghcr.io/w3security/cvescan-test-images:ubi-7",
			input:    "testdata/fixtures/images/ubi-7.tar.gz",
			golden:   "testdata/ubi-7.json.golden",
		},
		{
			name:     "debian buster/10",
			imageTag: "ghcr.io/w3security/cvescan-test-images:debian-buster",
		...
		},
		{
			...
			imageTag: "ghcr.io/w3security/cvescan-test-images:debian-stretch",
			input:    "testdata/fixtures/images/debian-stretch.tar.gz",
			golden:   "testdata/debian-stretch.json.golden",
		},
		{
			name:     "distroless base",
			imageTag: "ghcr.io/w3security/cvescan-test-images:distroless-base",
		...
		},
		{
			...
			imageTag: "ghcr.io/w3security/cvescan-test-images:opensuse-leap-151",
			input:    "testdata/fixtures/images/opensuse-leap-151.tar.gz",
			golden:   "testdata/opensuse-leap-151.json.golden",
		},
		{
			name:     "photon 3.0",
			imageTag: "ghcr.io/w3security/cvescan-test-images:photon-30",
			input:    "testdata/fixtures/images/photon-30.tar.gz",
			golden:   "testdata/photon-30.json.golden",
		},
		{
			name:     "CBL-Mariner 1.0",
			imageTag: "ghcr.io/w3security/cvescan-test-images:mariner-1.0",
			input:    "testdata/fixtures/images/mariner-1.0.tar.gz",
			golden:   "testdata/mariner-1.0.json.golden",
		},
		{
			name:     "busybox with Cargo.lock",
			imageTag: "ghcr.io/w3security/cvescan-test-images:busybox-with-lockfile",
